...
func (p *Popeye) Sanitize() (int, int, string, error) {
	defer func() {
		switch {
...
func (p *Popeye) dumpJSON() (string, error) {
...
func (p *Popeye) dump(printHeader bool) (string, error) {
